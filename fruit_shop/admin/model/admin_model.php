...
class AdminModel extends ConnectDB {
	...
	public function newCategories(){
		if (isset($_POST['newCategory'])){
			...
			$sql = "INSERT INTO categories (name,updated_at) VALUES ('$Category','$updated_at') ";
	...
	public function listCategories($start,$end){
		$list = $this->viewl('categories',$start,$end);
		return $list;
	}
	...
	public function addproducts(){
		...
		if(isset($_POST['submit']) && isset($_POST['name'])) {
			...
			//addproduct
			$sql = "INSERT INTO products (name,description,category_id,price,images,created_at,updated_at) VALUES ('$name','$description','$category','$price','$file','$day','$day')";	
			mysqli_query($this->conn,$sql);	
			$dir='public/uploads/';
